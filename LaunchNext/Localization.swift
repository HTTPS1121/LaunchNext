...
final class LocalizationManager {
    ...
    private init() {
        ...
        var hebrewDictionary = builder[.english] ?? [:]
        hebrewDictionary[.languagePickerTitle] = "שפה"
        hebrewDictionary[.languageNameSystem] = "עקוב אחר המערכת"
        hebrewDictionary[.languageNameEnglish] = "English"
        hebrewDictionary[.languageNameChinese] = "中文"
        hebrewDictionary[.languageNameJapanese] = "日本語"
        hebrewDictionary[.languageNameKorean] = "한국어"
        hebrewDictionary[.languageNameFrench] = "Français"
        hebrewDictionary[.languageNameSpanish] = "Español"
        hebrewDictionary[.languageNameItalian] = "Italiano"
        hebrewDictionary[.languageNameCzech] = "Čeština"
        hebrewDictionary[.languageNameGerman] = "Deutsch"
        hebrewDictionary[.languageNameRussian] = "Русский"
        hebrewDictionary[.languageNameHindi] = "हिन्दी"
        hebrewDictionary[.languageNameVietnamese] = "Tiếng Việt"
        hebrewDictionary[.languageNamePortugueseBrazil] = "Português (Brasil)"
        hebrewDictionary[.languageNameHebrew] = "עברית"

        hebrewDictionary.merge([
            .noAppsFound: "לא נמצאו אפליקציות",
            .searchPlaceholder: "חיפוש",
            .renameSearchPlaceholder: "חיפוש אפליקציות",
            .customTitlePlaceholder: "הזן שם מותאם אישית",
            .customTitleHint: "שנה שמות אפליקציות כאן. שמות מותאמים אישית נשמרים גם לאחר ייבוא ושינוי שפה.",
            .customTitleDefaultFormat: "ברירת מחדל: %@",
            .customTitleReset: "שחזר ברירת מחדל",
            .customTitleAddButton: "הוסף אפליקציה",
            .customTitleAddFromFolder: "הוסף אפליקציה",
            .loadMore: "טען עוד",
            .customTitleEmptyTitle: "אין שמות מותאמים אישית עדיין",
            .customTitleEmptySubtitle: "בחר אפליקציה כדי להתחיל לשנות שם. שמות מותאמים אישית נשמרים גם לאחר ייבוא ושינוי שפה.",
            .customTitleNoResults: "אין תוצאות",
            .customTitlePickerMessage: "בחר אפליקציה לניהול השם שלה.",
            .customTitleEdit: "עריכה",
            .customTitleSave: "שמור",
            .customTitleCancel: "ביטול",
            .customTitleOnly: "הצג רק אפליקציות עם שמות ערוכים.",
            .loadingApplications: "טוען אפליקציות…",
            .showFPSOverlay: "הצג שכבת FPS",
            .showFPSOverlayDisclaimer: "מדידה משוערת; ייתכן שלא תשקף את קצב הפריימים בפועל.",
            .showFPSOverlayWarning: "הפעלה זו עלולה להגביר משמעותית את השימוש ב-CPU ובזיכרון. זוהי תכונת בדיקה; השאר כבוי לשימוש רגיל.",
            .customIconTitle: "סמל האפליקציה",
            .customIconChoose: "בחר…",
            .customIconReset: "שחזר ברירת מחדל",
            .customIconHint: "קבצי PNG/ICNS ב-512×512 עובדים הכי טוב. השינויים חלים מיד.",
            .customIconError: "לא ניתן לטעון את התמונה שנבחרה.",
            .pageIndicatorOffsetLabel: "ריווח מחוון עמודים",
            .pageIndicatorTopPaddingLabel: "ריפוד עליון של מחוון עמודים",
            .layoutModeScopeFullscreen: "מסך מלא",
            .layoutModeScopeCompact: "קומפקטי",
            .indicatorOfflineDisplay: "תצוגה לא מקוונת",
            .indicatorOfflineBadge: "לא מקוון",
            .indicatorScreenIDFormat: "מזהה %@",
            .defaultOption: "ברירת מחדל",
            .customOption: "מותאם אישית",
            .perDisplayIndicatorPositionTitle: "מיקום מחוון לפי תצוגה",
            .perDisplayIndicatorPositionDescription: "השתמש בערכים שונים עבור כל תצוגה.",
            .applyDefaultsToCurrentDisplay: "החל ברירות מחדל על התצוגה הנוכחית",
            .folderWindowWidth: "רוחב חלון תיקייה",
            .folderWindowHeight: "גובה חלון תיקייה",
            .folderWindowSizeHint: "חל על מצב חלון בלבד; מסך מלא קלאסי משתמש בפריסה קבועה.",
            .appTitle: "LaunchNext",
            .modifiedFrom: "מבוסס על LaunchNow גרסה 1.3.1",
            .backgroundHint: "להפעלה ברקע: הוסף את LaunchNext לדוק או השתמש בקיצורי מקלדת לפתיחת חלון האפליקציה",
            .classicMode: "Launchpad קלאסי (מסך מלא)",
            .iconSize: "גודל סמל",
            .iconsPerRow: "סמלים בשורה",
            .rowsPerPage: "שורות בעמוד",
            .iconHorizontalSpacing: "ריווח אופקי",
            .iconVerticalSpacing: "ריווח אנכי",
            .labelFontSize: "גודל גופן תווית",
            .iconLabelFontWeight: "עובי תווית סמל",
            .folderDropZoneSize: "גודל אזור שחרור לתיקייה",
            .folderDropZoneSizeHint: "ערכים קטנים יותר מפחיתים יצירת תיקיות בטעות בעת גרירת סמלים במצב חלון.",
            .folderDropZoneSizeWithDefault: "גודל אזור שחרור לתיקייה (ברירת מחדל: %.1fx)",
            .smaller: "קטן יותר",
            .larger: "גדול יותר",
            .predictDrop: "נבא מיקום שחרור",
            .showLabels: "הצג תוויות מתחת לסמלים",
            .useLocalizedThirdPartyTitles: "השתמש בשמות אפליקציות מותאמים",
            .enableAnimations: "הפעל אנימציית הזזה",
            .windowOpenAnimationTitle: "אנימציית פתיחה/סגירה של חלון",
            .followScrollPagingTitle: "גלילה מדויקת לעמודים",
            .followScrollPagingDescription: "עמודים עוקבים אחר תנועות גלילה מדויקות (כבוי כברירת מחדל).",
            .reverseWheelPagingTitle: "הפוך כיוון גלגל עמודים",
            .hideDockOption: "הסתר Dock",
            .hoverMagnification: "הגדלה בריחוף",
            .hoverMagnificationScale: "קנה מידה ריחוף",
            .activePressEffect: "משוב לחיצה",
            .activePressScale: "קנה מידה לחיצה",
            .animationDurationLabel: "משך אנימציית הזזה",
            .gridSizeChangeWarning: "שינוי גודל הרשת עלול לשנות מיקום של כמה סמלים.",
            .pageIndicatorHint: "אם הריווח האנכי מרגיש עדין, כוון את הסטת מחוון העמודים למטה.",
            .rememberPageTitle: "זכור עמוד אחרון שנפתח",
            .globalShortcutTitle: "קיצור דרך ומחווה",
            .globalShortcutDescription: "השתמש בקיצור דרך גלובלי לפתיחה או סגירה מהירה של LaunchNext.",
            .shortcutSetButton: "הגדר קיצור דרך",
            .shortcutSaveButton: "שמור",
            .shortcutClearButton: "נקה",
            .shortcutNotSet: "לא מוגדר",
            .shortcutListening: "מאזין…",
            .shortcutCapturePrompt: "לחץ על צירוף המקשים הרצוי. לחץ Esc לביטול.",
            .shortcutNoModifierWarning: "שימוש ללא מקש ערוך עלול להתנגש עם אפליקציות אחרות.",
            .dockDragSectionTitle: "גרור אפליקציות ל-Dock",
            .dockDragSectionDescription: "בחר היכן גרירת Dock תופעל ועד כמה צריך לגרור לפני ש-LaunchNext מעביר ל-macOS.",
            .dockDragEnabledTitle: "הפעל גרירה ל-Dock",
            .dockDragSideTitle: "צד Dock",
            .dockDragTriggerDistanceTitle: "מרחק הפעלה",
            .dockDragDisabled: "כבוי",
            .dockDragSideBottom: "תחתון",
            .dockDragSideLeft: "שמאל",
            .dockDragSideRight: "ימין",
            .hotCornerSectionTitle: "פינה חמה",
            .hotCornerSectionDescription: "פתח את LaunchNext כשהמצביע מגיע לפינת המסך שנבחרה.",
            .hotCornerEnabledTitle: "הפעל פינה חמה",
            .hotCornerToggleWhenOpenTitle: "סגור כשכבר פתוח",
            .hotCornerPositionTitle: "פינה",
            .hotCornerTriggerDelayTitle: "עיכוב הפעלה",
            .hotCornerHitboxSizeTitle: "אזור הפעלה",
            .gestureSectionTitle: "מחוות",
            .gestureSectionDescription: "מחוות ניסיוניות של צביטה והקשה בארבע אצבעות עבור LaunchNext.",
            .gestureEnabledTitle: "הפעל צביטה בארבע אצבעות",
            .gestureCloseOnPinchOutTitle: "סגור עם פרישת ארבע אצבעות",
            .gestureTapActionTitle: "הקשה בארבע אצבעות",
            .gestureTapActionOff: "כבוי",
            .gestureTapActionOpen: "פתח",
            .gestureTapActionToggle: "החלף",
            .gestureSystemHintTitle: "הגדרת Trackpad",
            .gestureSystemHintBody: "כבה את 'הצג שולחן עבודה' בהגדרות מערכת > Trackpad > מחוות נוספות לפני השימוש במחווה זו.",
            .hotCornerPositionTopLeft: "שמאל עליון",
            .hotCornerPositionTopRight: "ימין עליון",
            .hotCornerPositionBottomLeft: "שמאל תחתון",
            .hotCornerPositionBottomRight: "ימין תחתון",
            .scrollSensitivity: "רגישות גלילה",
            .low: "נמוכה",
            .high: "גבוהה",
            .importSystem: "ייבא Launchpad מהמערכת",
            .importLegacy: "ייבא Legacy ‎(.lmy)",
            .importTip: "טיפ: לחץ על 'ייבא Launchpad מהמערכת' לייבוא ישיר מ-Launchpad המערכת.",
            .onboardingTitle: "הכן את LaunchNext",
            .onboardingSubtitle: "בחר פעולת הגדרה לפני טעינה ורינדור של כל סמלי האפליקציות.",
            .exportData: "ייצא נתונים",
            .importData: "ייבא נתונים",
            .dataManagementTitle: "ניהול נתונים",
            .layoutPresetTitle: "פריסה מוגדרת מראש",
            .layoutPresetDescription: "החל סידור ברירת מחדל בסגנון macOS 26. אפליקציות חסרות מדולגות והשאר מצורפות לאחר מכן.",
            .layoutPresetApplyButton: "החל פריסה קלאסית מוגדרת מראש",
            .layoutPresetAppliedTitle: "פריסה הוחלה",
            .layoutPresetAppliedMessage: "הפריסה המוגדרת מראש הוחלה על האפליקציות הנוכחיות שלך.",
            .layoutPresetApplyFailedMessage: "לא ניתן להחיל את הפריסה כי לא נמצאו אפליקציות זמינות.",
            .layoutPresetOtherFolderTitle: "אחר",
            .refresh: "רענן",
            .showQuickRefreshButton: "הצג כפתור רענון מהיר",
            .launchAtLoginTitle: "הפעלה שקטה בכניסה",
            .launchAtLoginDescription: "לאחר כניסה ל-macOS, LaunchNext מתחיל ברקע מבלי להציג את חלונו.",
            .lockLayoutTitle: "נעל פריסה",
            .lockLayoutDescription: "מנע סידור מחדש של אפליקציות ותיקיות עד שתכבה זאת.",
            .scanSourcesIntroTitle: "נהל ספריות אפליקציות נוספות",
            .scanSourcesIntroDescription: "הוסף כוננים חיצוניים או תיקיות מותאמות אישית כדי ש-LaunchNext יאסוף אפליקציות מחוץ למיקומים הרגילים.",
            .scanSourcesPlaceholder: "בקרוב: בחר תיקיות מותאמות אישית כאן ו-LaunchNext יסרוק וישמור על סנכרון.",
            .scanSourcesDefaultListTitle: "ספריות מערכת",
            .scanSourcesCustomListTitle: "ספריות מותאמות אישית",
            .scanSourcesAddButton: "הוסף תיקיות…",
            .scanSourcesResetButton: "שחזר ברירות מחדל",
            .scanSourcesEmptyHint: "אין ספריות מותאמות אישית עדיין. הוסף אחת כדי לשמור על סנכרון אפליקציות נוספות.",
            .scanSourcesMissingBadge: "לא מקוון",
            .missingAppBadge: "לא מקוון",
            .resetLayout: "אפס פריסה",
            .resetAlertTitle: "לאשר איפוס פריסה?",
            .resetAlertMessage: "פעולה זו תאפס לחלוטין את הפריסה: תסיר את כל התיקיות, תנקה את הסדר השמור ותסרוק מחדש את כל האפליקציות. כל ההתאמות האישיות יאבדו.",
            .resetConfirm: "אפס",
            .cancel: "ביטול",
            .quit: "יציאה",
            .appearanceModeTitle: "מראה",
            .appearanceModeFollowSystem: "אוטומטי",
            .appearanceModeLight: "בהיר",
            .appearanceModeDark: "כהה",
            .backgroundMaskTitle: "מסכת רקע",
            .backgroundMaskLightLabel: "מסכת מראה בהיר",
            .backgroundMaskDarkLabel: "מסכת מראה כהה",
            .folderPreviewHighResTitle: "תצוגות מקדימות של תיקיות ברזולוציה גבוהה",
            .folderPreviewHighResHint: "רנדר סמלי תיקיות בסולם Retina לתצוגות מקדימות חדות יותר (משתמש ביותר זיכרון).",
            .versionPrefix: "v",
            .versionLabelFormat: "גרסה %@",
            .versionFallback: "לא ידוע",
            .updatesHeroUpdateAvailable: "עדכון זמין",
            .updatesHeroUpToDate: "הגרסה מעודכנת",
            .aboutProjectLink: "קישור לפרויקט",
            .aboutReportBug: "דווח על באג",
            .aboutContribute: "תרום לפרויקט",
            .aboutBlog: "בלוג",
            .aboutInfoSystemTitle: "מערכת הפעלה",
            .aboutInfoMacOSLabel: "גרסת macOS",
            .aboutInfoMacOSValueFormat: "macOS %d.%d.%d",
            .aboutInfoProcessorTitle: "מידע על מעבד",
            .aboutInfoChipLabel: "שבב",
            .aboutInfoDisplayTitle: "תצוגות",
            .aboutInfoUnknownChip: "שבב לא ידוע",
            .aboutInfoUnknownDisplay: "לא ידוע",
            .aboutInfoDisplayGeneric: "תצוגה",
            .sidebarIconSizeTitle: "גודל סמל סרגל צד",
            .sidebarIconSizeLarge: "גדול",
            .sidebarIconSizeMedium: "בינוני",
            .folderNamePlaceholder: "שם תיקייה",
            .viewOnGitHub: "פתח קישור לפרויקט",
            .chooseButton: "בחר",
            .exportPanelMessage: "בחר תיקיית יעד לייצוא נתוני LaunchNext",
            .importPrompt: "ייבא",
            .importPanelMessage: "בחר תיקייה שיוצאה בעבר מ-LaunchNext",
            .legacyArchivePanelMessage: "בחר ארכיון Launchpad ישן ‎(.lmy/.zip) או קובץ db",
            .importSuccessfulTitle: "ייבוא הצליח",
            .importFailedTitle: "ייבוא נכשל",
            .okButton: "אישור",
            .checkForUpdates: "בדוק עדכונים",
            .checkForUpdatesButton: "בדוק עדכונים",
            .checkingForUpdates: "בודק עדכונים...",
            .upToDate: "הגרסה שלך עדכנית",
            .updateAvailable: "עדכון זמין",
            .newVersion: "גרסה חדשה:",
            .downloadUpdate: "הורד עדכון",
            .updateCheckFailed: "בדיקת עדכון נכשלה",
            .tryAgain: "נסה שנית",
            .autoCheckForUpdates: "בדוק עדכונים אוטומטית",
            .versionParseError: "שגיאת ניתוח גרסה",
            .updatesRefreshButton: "בדוק שוב",
            .openUpdaterConfig: "פתח קובץ הגדרות עדכון",
            .updaterConfirmTitle: "להתקין עדכון דרך Terminal?",
            .updaterConfirmMessage: "LaunchNext יצא וייפתח מעדכן Terminal. האפליקציה תיפתח מחדש אוטומטית לאחר השלמת ההתקנה.\n\nאם כפתור 'הורד עדכון' נראה שקוף, לחץ עליו בכל מקרה.\nזהו באג של macOS.⬇️",
            .updaterTerminalHint: "העדכון רץ ב-Terminal. LaunchNext יצא ויופעל מחדש אוטומטית.",
            .updaterLaunchFailed: "הפעלת המעדכן נכשלה ‎(%@).",
            .updaterMissingBinary: "קובץ בינארי של המעדכן לא נמצא בחבילת האפליקציה.",
            .updaterNotExecutable: "קובץ בינארי של המעדכן אינו ניתן להפעלה.",
            .updaterHoldPrompt: "לחץ Enter לסגירת חלון זה. LaunchNext ייפתח מחדש אוטומטית.",
            .settingsSectionGeneral: "כללי",
            .settingsSectionAppSources: "מקורות אפליקציות",
            .settingsSectionGameController: "בקר משחק",
            .settingsSectionAppearance: "מראה",
            .settingsSectionHiddenApps: "אפליקציות מוסתרות",
            .settingsSectionUninstall: "הסרת התקנה",
            .settingsSectionSound: "צליל",
            .settingsSectionTitles: "שמות אפליקציות",
            .settingsSectionPerformance: "ביצועים",
            .settingsSectionBackup: "גיבוי",
            .settingsSectionDevelopment: "פיתוח",
            .settingsSectionUpdates: "עדכונים",
            .settingsSectionAbout: "אודות",
            .backupPlaceholderTitle: "גיבוי",
            .backupPlaceholderSubtitle: "צור, נהל ושחזר גיבויים כאן.",
            .backupChooseFolderButton: "בחר תיקיית גיבוי",
            .backupCreateButton: "צור גיבוי",
            .backupDeleteSelectedButton: "מחק נבחרים",
            .backupCleanupDisclosureTitle: "נקה היסטוריה שאינה בשימוש (מתקדם)",
            .backupCleanupIntroPrimary: "LaunchNext שומר היסטוריית שינויים מקומית במסד הנתונים שלו. האפליקציה אינה משתמשת בהיסטוריה זו, אך היא יכולה לגדול עם הזמן.",
            .backupCleanupIntroSecondary: "אנחנו לא מריצים זאת בתוך האפליקציה מכיוון שזה הרסני ומצריך את מסד הנתונים לסגור. ביצוע ידני ב-Terminal מונע אובדן נתונים בשוגג.",
            .backupCleanupWarning: "חשוב: צא מ-LaunchNext לפני הרצת הפקודה, אחרת מסד הנתונים עלול להיות נעול.",
            .backupCleanupInstruction: "הרץ פקודה זו ב-Terminal כדי להסיר שורות היסטוריה ולכווץ את מסד הנתונים.",
            .backupCleanupCopyButton: "העתק",
            .backupCleanupCopiedLabel: "הועתק",
            .backupCleanupCommandDetails: "פרטי פקודה: `PRAGMA wal_checkpoint(FULL)` מרוקן את WAL, `DELETE FROM ACHANGE` מסיר שורות היסטוריה, ו-`VACUUM` מפנה מקום.",
            .backupNoFolderSelected: "לא נבחרה תיקיית גיבוי.",
            .backupNoBackupsFound: "לא נמצאו גיבויים.",
            .backupImportButton: "ייבא",
            .backupDeleteButton: "מחק",
            .backupEstimatedSizeHint: "גודל משוער מבוסס על Data.store.",
            .backupDeleteMultipleTitle: "מחק גיבויים",
            .backupDeleteMultipleMessageFormat: "פעולה זו תסיר לצמיתות %d גיבויים שנבחרו.",
            .backupDeleteSingleTitle: "מחק גיבוי",
            .backupDeleteSingleMessage: "פעולה זו תסיר לצמיתות את הגיבוי שנבחר.",
            .developmentPlaceholderTitle: "מגרש פיתוח",
            .developmentPlaceholderSubtitle: "שמור לכלים עתידיים ותכונות ניסיוניות.",
            .developmentEnableCLICodeTitle: "ממשק שורת פקודה",
            .developmentEnableCLICodeHint: "כשכבוי, גישת CLI/TUI לטרמינל חסומה. השאר כבוי אלא אם אתה בודק באופן פעיל.",
            .commandLineInterfaceHelpTitle: "ממשק שורת פקודה",
            .commandLineInterfaceHelpBody: "הפעלה זו כותבת את שם `launchnext` לנתיב המעטפת שלך. כיבוי מסיר אותו.\nCLI: LaunchNext --cli help\nTUI: LaunchNext --tui",
            .commandLineInterfaceShowFullPathCommand: "הצג פקודת נתיב הפעלה מלא",
            .commandLineInterfaceAgentHint: "תכונה זו מיועדת בעיקר לזרימות עבודה של Agent.",
            .commandLineInterfaceRemoveCommandButton: "הסר שם שהוזרק",
            .commandLineInterfaceRemoveCommandDone: "השם שהוזרק הוסר.",
            .commandLineInterfaceRemoveCommandMissing: "לא נמצא שם מנוהל שהוזרק.",
            .commandLineInterfaceRemoveCommandInfoTitle: "מה פעולה זו מריצה",
            .commandLineInterfaceRemoveCommandInfoBody: "כפתור זה מסיר רק shims של LaunchNext CLI מנוהלים (לא קבצים לא קשורים):\nrm /opt/homebrew/bin/launchnext\nrm /usr/local/bin/launchnext\nrm ~/.local/bin/launchnext\nrm ~/bin/launchnext\nאז הוא מסיר את קטע PATH של LaunchNext מ-~/.zprofile.",
            .developmentForceOnboardingButton: "הצג קליטה בכפייה",
            .developmentForceOnboardingHint: "Launchpad קלאסי (מסך מלא) בלבד. סגור הגדרות ולאחר מכן הצג קליטה מיד לצורך בדיקה.",
            .gameControllerPlaceholderTitle: "תמיכת בקר",
            .gameControllerPlaceholderSubtitle: "חבר בקר והשתמש ב-D-pad לניווט בין אפליקציות. אפשרויות נוספות יגיעו בקרוב.",
            .gameControllerToggleTitle: "הפעל ניווט בבקר",
            .gameControllerStatusDisabled: "ניווט בבקר כבוי.",
            .gameControllerStatusNoController: "לא זוהו בקרים עדיין.",
            .gameControllerStatusConnectedFormat: "בקרים מחוברים: %@",
            .gameControllerQuickGuideTitle: "מדריך מהיר",
            .gameControllerQuickGuideDirection: "השתמש ב-D-pad או מקל שמאלי לניווט בין סמלים.",
            .gameControllerQuickGuideSelect: "כפתור A מאשר את הבחירה.",
            .gameControllerQuickGuideCancel: "כפתור B סוגר את Launchpad.",
            .gameControllerQuickGuideMenuToggle: "כפתור Menu מחליף Launchpad.",
            .gameControllerMenuToggleTitle: "השתמש בכפתור Menu להחלפת Launchpad",
            .gameControllerMenuToggleSubtitle: "עובד כמו קיצור הדרך הגלובלי (פתיחה/סגירה).",
            .soundToggleTitle: "הפעל אפקטי צליל",
            .soundToggleDescription: "השתמש בצלילי מערכת macOS לפעולות LaunchNext.",
            .soundEventLaunchpadOpen: "Launchpad נפתח",
            .soundEventLaunchpadClose: "Launchpad נסגר",
            .soundEventNavigation: "הזז מיקוד",
            .soundPreviewButton: "תצוגה מקדימה",
            .soundOptionNone: "ללא",
            .voiceToggleTitle: "הפעל Voice Over",
            .voiceToggleDescription: "הכרז על שם האפליקציה הממוקדת בעת שימוש בניווט מקלדת או בקר.",
            .voiceNoteMutualExclusive: "Voice Over מחליף את אפקט הצליל לניווט.",
            .voiceAnnouncementAppFormat: "%@",
            .voiceAnnouncementFolderFormat: "תיקייה: %@",
            .backgroundStyleTitle: "סגנון רקע",
            .backgroundStyleOptionBlur: "טשטוש",
            .backgroundStyleOptionGlass: "זכוכית נוזלית",
            .hiddenAppsAddButton: "הסתר אפליקציה",
            .hiddenAppsEmptyTitle: "אין אפליקציות מוסתרות עדיין",
            .hiddenAppsEmptySubtitle: "בחר אפליקציה כדי להסתיר אותה מ-LaunchNext.",
            .hiddenAppsHint: "אפליקציות מוסתרות נעלמות מהרשת. הסר אותן מכאן לשחזור.",
            .hiddenAppsRemoveButton: "בטל הסתרה",
            .hiddenAppsSearchPlaceholder: "סנן אפליקציות מוסתרות",
            .notHiddenAppsTitle: "אפליקציות לא מוסתרות",
            .notHiddenAppsHint: "בחר אפליקציה כדי להסתיר אותה מ-LaunchNext.",
            .notHiddenAppsSearchPlaceholder: "סנן אפליקציות לא מוסתרות",
            .contextMenuDissolveFolder: "פרק תיקייה",
            .contextMenuUninstallWithConfiguredTool: "הסר התקנה עם הכלי המוגדר",
            .contextMenuBatchSelectApps: "בחירה קבוצתית של אפליקציות",
            .contextMenuFinishBatchSelection: "סיים בחירה קבוצתית",
            .uninstallSectionDescription: "בחר אפליקציית הסרה של צד שלישי (לדוגמה AppCleaner). LaunchNext יכול לפתוח אותה בעת הצורך.",
            .uninstallToolPathLabel: "מסיר התקנה שנבחר",
            .uninstallToolNotConfigured: "לא נבחר מסיר התקנה.",
            .uninstallToolMissing: "מסיר ההתקנה שנבחר לא נמצא. אנא בחר שוב.",
            .uninstallToolChooseButton: "בחר אפליקציה…",
            .uninstallToolClearButton: "נקה",
            .uninstallToolOpenButton: "פתח מסיר התקנה",
            .uninstallToolPanelTitle: "בחר אפליקציית הסרת התקנה",
            .accessibilityPlaceholderTitle: "בקרי נגישות",
            .accessibilityPlaceholderSubtitle: "הגדרות נגישות מתוכננות; אין כאן עדיין.",
            .performancePlaceholderTitle: "לוח ביצועים",
            .performancePlaceholderSubtitle: "מדדי ניטור יופיעו כאן בקרוב.",
            .performanceModeTitle: "מצב ביצועים",
            .performanceModeSubtitle: "עבור בין Legacy Engine ל-Next Engine.",
            .performanceModeFull: "Legacy Engine",
            .performanceModeLean: "Next Engine",
            .performanceModeDescriptionFull: "Legacy Engine שומר על מטמון ישן לאבטחה מרבית.",
            .performanceModeDescriptionLean: "Next Engine משתמש בפחות זיכרון לביצועים חלקים יותר.",
            .performanceRendererRecommendation: "מומלץ מאוד.",
            .performanceModeRestartHint: "החלפת מצבים מצריכה הפעלה מחדש.",
            .performanceModeRestartTitle: "נדרשת הפעלה מחדש",
            .performanceModeRestartMessage: "אנא הפעל מחדש את LaunchNext להחלת מצב הביצועים החדש.",
            .performanceRendererTitle: "Next Engine עם Core Animation",
            .performanceRendererBadge: "ניסיוני",
            .performanceRendererSubtitle: "מצריך Next Engine.",
            .performanceRendererWarning: "מופעל. אם אתה מבחין בבעיות, כבה זאת.",
            .performanceOverviewTitle: "סקירת ביצועים",
            .performanceOverviewSubtitle: "תמונת מצב מהירה של שימוש בזיכרון ופעילות מטמון.",
            .performanceMemoryLabel: "שימוש בזיכרון",
            .performanceCacheTitle: "מצב מטמון",
            .performanceCacheStatusValid: "מטמון מוכן",
            .performanceCacheStatusInvalid: "מטמון נבנה מחדש",
            .performanceCacheLastUpdateLabel: "עדכון אחרון",
            .performanceCacheNever: "מעולם לא",
            .performanceCacheClearButton: "נקה מטמונים",
            .performanceCacheIconLabel: "מטמון סמלים",
            .performanceCacheAppInfoLabel: "מטמון מידע אפליקציה",
            .performanceCacheGridLabel: "מטמון רשת",
            .performanceCacheTotalLabel: "סה\"כ מטמון",
            .performanceCacheCountsHint: "מספרים אלו מציגים ספירת פריטים, לא גודל זיכרון.",
            .performanceCacheIconsDisabled: "מנוטרל ב-Next Engine",
            .performanceCacheLeanHint: "Next Engine מדלג על מטמון סמלים כדי להפחית שימוש בזיכרון ועצירות.",
            .performanceModeRecommendation: "מומלץ: Next Engine לזיכרון נמוך וביצועים חלקים יותר.",
            .onboardingFlowWelcomeTitle: "ברוך הבא ל-LaunchNext",
            .onboardingFlowWelcomeSubtitle: "הפוך את LaunchNext לשלך.",
            .onboardingFlowProgressFormat: "שלב %d/%d",
            .onboardingFlowPoweredBy: "RoversX / CloseX.org",
            .onboardingFlowSkip: "דלג על קליטה",
            .onboardingFlowBack: "חזרה",
            .onboardingFlowStart: "התחל",
            .onboardingFlowNext: "הבא",
            .onboardingFlowDone: "סיום",
            .onboardingFlowIntroTitle: "מוכן להתחיל",
            .onboardingFlowIntroSubtitle: "להפעלה הראשונה, השלם פעולות הגדרה אלו. ניתן לדלג כעת ולהמשיך מאוחר יותר בהגדרות.",
            .onboardingFlowIntroImportItem: "ייבא פריסת מערכת",
            .onboardingFlowIntroPresetItem: "החל פריסה קלאסית",
            .onboardingFlowIntroShortcutItem: "הגדר קיצור דרך גלובלי",
            .onboardingFlowLayoutStepTitle: "שלב 1: אתחול פריסה",
            .onboardingFlowLayoutStepSubtitle: "בחר ייבוא מהמערכת או פריסה קלאסית, או המשך ישירות לשלב הבא.",
            .onboardingFlowLayoutChooseMethod: "בחר שיטת אתחול",
            .onboardingFlowLayoutOptionATitle: "אפשרות א'",
            .onboardingFlowLayoutOptionASubtitle: "ייבא Launchpad מהמערכת",
            .onboardingFlowLayoutOptionADetail: "הקרוב ביותר לפריסת macOS הנוכחית שלך.",
            .onboardingFlowLayoutOptionAUnavailableDetail: "לא נמצא מסד נתוני מערכת לייבוא.",
            .onboardingFlowLayoutOptionAButton: "השתמש בפריסת מערכת",
            .onboardingFlowLayoutOptionAUnavailableButton: "לא זמין",
            .onboardingFlowLayoutOptionBTitle: "אפשרות ב'",
            .onboardingFlowLayoutOptionBSubtitle: "החל פריסה קלאסית מוגדרת מראש",
            .onboardingFlowLayoutOptionBDetail: "מצוין ל-Mac חדש; ניתן לכוון מאוחר יותר.",
            .onboardingFlowLayoutOptionBButton: "השתמש בפריסה קלאסית",
            .onboardingFlowLayoutSkipButton: "דלג כעת והמשך",
            .onboardingFlowShortcutStepTitle: "שלב 2: הגדר קיצור דרך גלובלי",
            .onboardingFlowShortcutStepSubtitle: "הגדר קיצור דרך לפתיחת LaunchNext בכל עת מבלי לחזור לחלון האפליקציה.",
            .onboardingFlowShortcutStepButton: "פתח הגדרות קיצור דרך",
            .onboardingFlowCompletionHeadline: "קוד פתוח, קל משקל, ניתן להתאמה אישית",
            .onboardingFlowCompletionDescription: "פריסת האפליקציות שלך, בדרך שלך.",
            .onboardingFlowSidebarStart: "התחל",
            .onboardingFlowSidebarLayout: "פריסה",
            .onboardingFlowSidebarShortcut: "קיצור דרך",
            .onboardingFlowSidebarDone: "סיום"
        ]) { _, new in new }

        builder[.hebrew] = hebrewDictionary
